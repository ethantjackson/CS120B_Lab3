...
tests = [ {'description': 'PINA: 0x00, PINB: 0x00 => PINC: 0x00',
    ...
    {'description': 'PINA: 0xFF, PINB: 0x00 => PINC: 8',
    'steps': [ {'inputs': [('PINA',0xFF),('PINB',0x00)], 'iterations': 1 } ],
    'expected': [('PORTC',8)],
    },
    {'description': 'PINA: 0x01, PINB: 0x01 => PINC: 2',
    'steps': [ {'inputs': [('PINA',0x01),('PINB',0x01)], 'iterations': 1 } ],
    'expected': [('PORTC',2)],
    },
    {'description': 'PINA: 0xFF, PINB: 0xFF => PINC: 16',
